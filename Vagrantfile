...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "henryhu-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/tigerhu"
  #   chef.validation_client_name = "tigerhu-validator"
  #   chef.validation_key_path = ".chef/tigerhu-validator.pem"
  # end
end
